// src/pages/services/accounting/tax-preparation.js
...
import { Check, ShieldCheck, Search, Calendar } from 'lucide-react';
...
const pageData = accountingOfferingsDetails.find(o => o.id === 'tax-preparation');

const whyChooseUsIconMap = {
    "Maximize Your Deductions": Search,
    "Avoid Costly Errors": ShieldCheck,
      ...
      <div ref={mainRef} className="bg-white">
        ...
        <section className="py-10 bg-light-bg">
          <div className="container-padding max-w-4xl mx-auto">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-secondary">Our Tax Services Include</h2>
            </div>
        ...
        {pageData.whyChooseUs && (
            <section className="py-10">
                <div className="container-padding">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold" style={{ color: SECONDARY_COLOR }}>Why Choose Us for Tax Preparation?</h2>
                    </div>
        ...
        <section className="section-padding" style={{backgroundColor: DARK_TEXT}}>
            <div className="container-padding text-center">
                <h2 className="text-3xl font-bold text-white mb-6">Ready to Simplify Your Taxes?</h2>
