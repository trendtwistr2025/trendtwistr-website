// src/pages/services/accounting/advisory-services.js
...
import { Check, Rocket, Factory, Users as UsersIcon } from 'lucide-react';
...
const pageData = accountingOfferingsDetails.find(o => o.id === 'advisory-services');

const whoWeServeIconMap = {
    "Startups & Entrepreneurs": Rocket,
    "Established SMEs": Factory,
    "Family-Owned Businesses": UsersIcon,
};
...
const AdvisoryServicesPage = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 4. Elastic Pop-in for Who We Serve items
      ...
      <div ref={mainRef} className="bg-white">
        ...
        <section className="py-10 bg-light-bg">
          <div className="container-padding max-w-4xl mx-auto">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-secondary">Our Advisory Services Include</h2>
            </div>
        ...
        {pageData.whoWeServe && (
            <section className="py-10">
                <div className="container-padding">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold" style={{ color: SECONDARY_COLOR }}>Who We Serve</h2>
                    </div>
                    <div className="clients-grid grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {pageData.whoWeServe.map((client) => {
                            const Icon = whoWeServeIconMap[client.title] || Check;
                            return (
                                <div key={client.title} className="client-item text-center">
                                    ...
                                    <h3 className="text-xl font-semibold text-dark-text mb-3">{client.title}</h3>
                                    <p className="text-subtle-text text-sm">{client.description}</p>
                                </div>
                            );
                        })}
                    </div>
        ...
        <section className="section-padding" style={{backgroundColor: DARK_TEXT}}>
            <div className="container-padding text-center">
                <h2 className="text-3xl font-bold text-white mb-6">Ready for Strategic Financial Guidance?</h2>
