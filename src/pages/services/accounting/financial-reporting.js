// src/pages/services/accounting/financial-reporting.js
...
import { Check, BarChart2, ShieldCheck, TrendingUp } from 'lucide-react';
...
const pageData = accountingOfferingsDetails.find(o => o.id === 'financial-reporting');

const whyItMattersIconMap = {
    "Strategic Decision-Making": TrendingUp,
    "Investor & Stakeholder Confidence": BarChart2,
    "Compliance & Peace of Mind": ShieldCheck,
};
...
const FinancialReportingPage = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 4. Elastic Pop-in for Why It Matters items
  ...
  return (
    <>
      ...
      <div ref={mainRef} className="bg-white">
        ...
        <section className="py-10 bg-light-bg">
          <div className="container-padding max-w-4xl mx-auto">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-secondary">Our Reporting Services Include</h2>
            </div>
        ...
        {pageData.whyItMatters && (
            <section className="py-10">
                <div className="container-padding">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold" style={{ color: SECONDARY_COLOR }}>Why Accurate Reporting Matters</h2>
                    </div>
                    <div className="benefits-grid grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {pageData.whyItMatters.map((benefit) => {
                            const Icon = whyItMattersIconMap[benefit.title] || Check;
                            return (
        ...
        <section className="section-padding" style={{backgroundColor: DARK_TEXT}}>
            <div className="container-padding text-center">
                <h2 className="text-3xl font-bold text-white mb-6">Need Clarity in Your Financials?</h2>
