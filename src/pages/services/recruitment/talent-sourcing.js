// src/pages/services/recruitment/talent-sourcing.js
...
import { Check, Search, Zap, Heart } from 'lucide-react';
...
const pageData = recruitmentOfferingsDetails.find(o => o.id === 'talent-sourcing');

const advantageIconMap = {
    "Access to Passive Talent": Search,
    "Faster Hiring Process": Zap,
    "Cultural Fit Focus": Heart,
};

const TalentSourcingPage = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 4. Elastic Pop-in for Advantage items
      const advantageItems = gsap.utils.toArray(".advantage-item");
      gsap.from(advantageItems, {
        ...
        scrollTrigger: { trigger: ".advantage-grid", start: "top 80%" }
      });
      ...
      <div ref={mainRef} className="bg-white">
        ...
        <div className="bg-light-bg border-b border-slate-200">
            <div className="container-padding py-4 text-sm text-subtle-text">
                ...
                <Link href="/services/recruitment" className="hover:text-primary">Recruitment</Link>
                <span className="mx-2">&gt;</span>
        ...
        <section className="py-10 bg-light-bg">
          <div className="container-padding max-w-4xl mx-auto">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-secondary">Our Talent Sourcing Services Include</h2>
            </div>
        ...
        {pageData.whyChooseUs && (
            <section className="py-10">
                <div className="container-padding">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold" style={{ color: SECONDARY_COLOR }}>The Trendtwistr Advantage</h2>
                    </div>
                    <div className="advantage-grid grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {pageData.whyChooseUs.map((benefit) => {
                            const Icon = advantageIconMap[benefit.title] || Check;
                            return (
                                <div key={benefit.title} className="advantage-item text-center">
        ...
        <section className="section-padding" style={{backgroundColor: DARK_TEXT}}>
            <div className="container-padding text-center">
                <h2 className="text-3xl font-bold text-white mb-6">Ready to Find the Best Talent?</h2>
...
export default TalentSourcingPage;