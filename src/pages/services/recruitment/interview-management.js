// src/pages/services/recruitment/interview-management.js
...
import { Check, Smile, Clock, BarChartHorizontal } from 'lucide-react';
...
const pageData = recruitmentOfferingsDetails.find(o => o.id === 'interview-management');

const benefitsIconMap = {
    "Improved Candidate Experience": Smile,
    "Reduced Time-to-Hire": Clock,
    "Unbiased & Data-Driven Decisions": BarChartHorizontal,
};
...
const InterviewManagementPage = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 4. Elastic Pop-in for Benefits items
      ...
      <div ref={mainRef} className="bg-white">
        ...
        <section className="py-10 bg-light-bg">
          <div className="container-padding max-w-4xl mx-auto">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-secondary">Our Interview Management Includes</h2>
            </div>
        ...
        {pageData.benefits && (
            <section className="py-10">
                <div className="container-padding">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold" style={{ color: SECONDARY_COLOR }}>Benefits of Our Managed Process</h2>
                    </div>
                    <div className="benefits-grid grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {pageData.benefits.map((benefit) => {
                            const Icon = benefitsIconMap[benefit.title] || Check;
                            return (
        ...
        <section className="section-padding" style={{backgroundColor: DARK_TEXT}}>
            <div className="container-padding text-center">
                <h2 className="text-3xl font-bold text-white mb-6">Ready to Streamline Your Interviews?</h2>
