// src/pages/services/recruitment/candidate-screening.js
...
import { Check, Star, Clock, UserCheck } from 'lucide-react';
...
const pageData = recruitmentOfferingsDetails.find(o => o.id === 'candidate-screening');

const benefitsIconMap = {
    "Higher Quality Hires": Star,
    "Reduced Hiring Time": Clock,
    "Increased Retention": UserCheck,
};
      ...
      <div ref={mainRef} className="bg-white">
        ...
        <section className="py-10 bg-light-bg">
          <div className="container-padding max-w-4xl mx-auto">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-secondary">Our Screening Process Includes</h2>
            </div>
        ...
        {pageData.benefits && (
            <section className="py-10">
                <div className="container-padding">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold" style={{ color: SECONDARY_COLOR }}>Benefits of Our Screening Process</h2>
                    </div>
        ...
        <section className="section-padding" style={{backgroundColor: DARK_TEXT}}>
            <div className="container-padding text-center">
                <h2 className="text-3xl font-bold text-white mb-6">Find Your Perfect Candidate</h2>
