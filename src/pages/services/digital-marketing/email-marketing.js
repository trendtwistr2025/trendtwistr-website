// src/pages/services/digital-marketing/email-marketing.js
...
const pageData = digitalMarketingOfferingsDetails.find(o => o.id === 'email-marketing');
      ...
      <div ref={mainRef} className="bg-white">
        ...
        {pageData.ourProcess && (
            <section className="section-padding">
                <div className="container-padding">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold" style={{ color: SECONDARY_COLOR }}>Our Email Marketing Process</h2>
                    </div>
        ...
        {/* --- "PLATFORMS WE USE" SECTION (RESTORED) --- */}
        {pageData.platforms && (
            <section className="section-padding bg-light-bg">
                <div className="container-padding">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold" style={{ color: SECONDARY_COLOR }}>Platforms We Use</h2>
                    </div>
